...
knitr::include_graphics("img/helsinki.png")
```
]
]
]
...
<br>
```{r, echo=FALSE, out.width="90%", fig.cap = "Source: ETIENNE et al., 2006", fig.align="center" }
knitr::include_graphics("img/neutral.jpg")
```
]
]
]
...
knitr::include_graphics("img/mbfg.png")
```
<br>
.right[...or measure **individual traits** and match them with environmental template]
```{r, echo=FALSE, fig.cap="Source: BLONDER et al. 2014", out.width='70%',fig.align='center'}
knitr::include_graphics("img/multi_niche.gif")
```
]]
---
...
knitr::include_graphics("img/EN_evo.png")
```
]]
]]
...
knitr::include_graphics("img/EN.png")
```
...
<br>
```{r, echo=FALSE, fig.cap="", out.width='65%', fig.align='center', fig.cap="Source: SEGURA et al., 2010"}
knitr::include_graphics("img/en_segura.png")
```
]
]
]
...
<br>
<br>
```{r, echo=FALSE, fig.cap="", out.width='100%', fig.align='center', fig.cap="Source: D'ANDREA et al., 2020"}
knitr::include_graphics("img/en_bs.png")
```
]
]
...
.row[
.content.nopadding[
```{r, echo=FALSE, fig.cap="Source: NEKOLA & MCGILL, 2014", out.width="50%", fig.align='center'}
knitr::include_graphics("img/DD_nekola.png")
```
]]
...
knitr::include_graphics("img/map_cap1.png")
```
]]
.column[.content.nopadding[
...
knitr::include_graphics("img/cap1_rlq.png")
```
]]
...
```{r, echo=FALSE}
knitr::include_graphics("img/cap1_clump_season.png")
```
]
  .panel[.panel-name[Spatial]

```{r, echo=FALSE, out.width="80%", fig.align="center"}
knitr::include_graphics("img/cap1_clump_spatial.png")
```
]
...
knitr::include_graphics("img/cap2_map.png")
```
]
.panel[.panel-name[Reservoirs]
```{r, echo=FALSE, out.width='100%', fig.align='center', fig.cap="Souce: GRACO-ROZA et al. 2020"}
knitr::include_graphics("img/cap2_table1.png")
```
]
...
.panelset[
  .panel[.panel-name[Shape of the curve]
```{r, echo=FALSE, out.width='100%', fig.align="center"}
knitr::include_graphics("img/cap2_fig3.png")
```
]
.panel[.panel-name[Variable importance]
.tiny[
...
knitr::include_graphics('img/cap3_fig1.png')
```
...
knitr::include_graphics('img/cap3_fig2.png')
```
]]
...
### Data analysis
```{r,echo=FALSE, out.width="80%"}
knitr::include_graphics('img/cap3_fig3.png')
```
]]
---
class:split-40
...
```{r, echo=FALSE, fig.align="center"}
knitr::include_graphics('img/cap3_fig4.png')
```
]
.panel[
.panel-name[Across taxa]
```{r, echo=FALSE, out.width="70%", fig.align="center"}
knitr::include_graphics('img/cap3_fig5.png')
```
...
```{r, echo=FALSE}
knitr::include_graphics('img/cap3_fig6.png')
```
]
.panel[
.panel-name[Biological variables]
```{r, echo=FALSE}
knitr::include_graphics('img/cap3_fig7.png')
```
